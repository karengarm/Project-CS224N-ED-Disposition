...
data_train = pd.read_csv('/root/data/ed_train_wiht_l2v.csv')
data_test = pd.read_csv('/root/data/ed_test_wiht_l2v.csv')
data_val = pd.read_csv('/root/data/ed_val_wiht_l2v.csv')
...
def create_bert(learning_rate=1e-3, dropout=0.1):
    ...
    layer1 = tf.keras.layers.Dropout(0.0001, name='Dropout')(outputs['pooled_output'])
    # Freeze the layer1
...
mlflow.set_experiment("/Users/karengar@stanford.edu/BERT_with_labels")
